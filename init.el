...
(try-require 'auto-complete-conf)
(try-require 'neotree-conf)
(try-require 'basic-edit-conf)
(try-require 'smartparens-conf) 
(try-require 'setup-helm)
(try-require 'sr-speedbar-conf)
(try-require 'utf8-set)
(try-require 'ace-jump-conf)
(try-require 'recent-jump-conf)
(try-require 'copy-paste-conf)
(try-require 'projectile-conf)
